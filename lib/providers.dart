...
/// Ahora usa las palabras de la categoría seleccionada
@riverpod
Future<BuiltSet<String>> wordList(WordListRef ref) async {
  ...
  if (selectedCategory != null) {
    return await ref.watch(categoryWordsProvider(selectedCategory.id).future);
  }
  
  // Fallback: usar el archivo words.txt (comportamiento original)
